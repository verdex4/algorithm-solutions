...
Можно вместо словаря хранить список (это про [[Превращение словаря в список]]), ведь индекс любой буквы мы можем вычислить через `ord(letter) - ord('a')`
...
- Optional: [[Превращение словаря в список]]